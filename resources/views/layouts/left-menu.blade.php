<div class="col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0">
    <div class="d-flex flex-column align-items-center align-items-sm-start min-vh-100">
                <ul class="nav flex-column pt-2 w-100">
                    ...
                    @endif
                    <li class="nav-item">
                    <a type="button" href="{{url('payment')}}" class="d-flex nav-link {{ request()->is('attendances*')? 'active' : '' }}"><i class="bi bi-currency-exchange"></i> <span class="ms-2 d-inline d-sm-none d-md-none d-xl-inline">School Fees</span></a>
                    </li>
                    <li class="nav-item">
                    <a type="button" href="{{url('payment')}}" class="d-flex nav-link {{ request()->is('attendances*')? 'active' : '' }}"><i class="bi bi-currency-exchange"></i> <span class="ms-2 d-inline d-sm-none d-md-none d-xl-inline">Other Fees</span></a>
                    </li>
                    @if (Auth::user()->role == "admin")
                    <li class="nav-item">
